...
const Chat = () => {
  ...
  return (
    <div className="flex flex-col w-full max-w-2xl mx-auto h-[80vh] bg-gray-50 border rounded-2xl shadow-md p-4">
      {/* Header */}
      <div className="flex justify-between items-center mb-3 border-b pb-2">
        <h2 className="text-xl font-semibold text-gray-700">Chatbot</h2>
        <span className={`px-3 py-1 rounded-full text-sm font-medium ${
            mood === "happy" ? "bg-yellow-200 text-yellow-800" :
      ...
      <div className="flex items-center gap-2">
        <textarea
          ...
          className="flex-1 border border-gray-300 rounded-xl p-2 focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none h-12"
        />
        <button
          onClick={handleSend}
